...
train_samples = torch.tensor(mnist_data.get_tensor("samples"))[0:10000]
train_labels = torch.tensor(mnist_data.get_tensor("labels"))[0:10000]
...
client.set_model("trained_model", buffer.getvalue(), "TORCH", device="CPU")
