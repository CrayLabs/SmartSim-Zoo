...
conda create --prefix /lus/theta-fs0/projects/datascience/$USER/conda/envs/ss_env python=3.8 -y
conda activate /lus/theta-fs0/projects/datascience/arigazzi/conda/envs/ss_env
pip install cmake
cd /lus/theta-fs0/projects/datascience/$USER
