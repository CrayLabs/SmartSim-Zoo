...
def parse_command_line(args, description):
    ...
    parser.add_argument("--account", default="P93300606", help="Account ID")
    parser.add_argument("--db-port", default=6780, help="db port, default=6780")
    ...
    return {
        ...
        "ngpus": ngpus,
        "client_nodes": args.ensemble_size * args.member_nodes,
        "walltime": args.walltime,
        "account": args.account,
        "member_nodes": args.member_nodes,
...
def _main_func(desc):
    ...
    template_files = [
        "resv_job.template",
        "launch_database_cluster.template",
